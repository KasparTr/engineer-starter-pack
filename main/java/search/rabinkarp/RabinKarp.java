...
/**
 * Rabin Karp uses hashing to find an exact match of a pattern string in a text.
 ...
 *
 * Good alternative to using Rabin Karp is to use Aho Corasick algorithm (uses Trie datastructure)
